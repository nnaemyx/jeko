...
const Business = () => {
  return (
    <div>
        <div>
            <h2 className='font-space_grotesk text-[40px] font-bold lg:pl-[158px] pl-[16px] lg:text-[64px]'>Business Cards</h2>
            <div className='mx-auto text-center flex justify-center'>
                <Image src={Businesscards} alt='business cards'/>
            </div>
            <div className="mt-[23px] lg:mt-[62px] lg:mb-[67px] mb-[89px]">
					<Button
						withArrow
